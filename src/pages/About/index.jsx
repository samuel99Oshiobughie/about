        ...
        {innerWidth < 600 ? (
            ...
            <div>
                ...
                <p className={styles.intro}>
                    Join a community of over 100+ tech professionals available to<br /> work with you. Get Started.<br />
                    <span style={{color: "#1D1DD8"}}>No credit card required</span> - Free trial tokens - <span style={{color: "#1D1DD8"}}>Cancel anytime.</span>
                </p>
                ...
                <h4 className={styles.secondHeader}><span style={{color: "#1D1DD8"}}>Fostering Innovation</span> with the right solution
                </h4>
                <p className={styles.secondIntro}>
                Ever got stuck on a line of code which took you a few minutes to resolve. Devask is bridging that gap with over 100+ tech professionals available to<br /> answer your questions realtime. Let’s solve that problem together.
                </p>
